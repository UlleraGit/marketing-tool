...
export default function ipSurveyChart(props) {
    ...
    const fetcher = (...args) => fetch(...args, {
        ...
        .then(res => res.json())
        .then(r => {
            let formatedDate = `${new Date(r.creationTime).getDate()}.${new Date(r.creationTime).getMonth() + 1}.${new Date(r.creationTime).getFullYear()}`;
            ...
            return ({ title: r.title, ages, genders, agesSum: Array.from(agesSum.values()), gendersSum: Array.from(gendersSum.values()), answerA: r.answerA, answerB: r.answerB, answers: [r.answers.answers[1].value, r.answers.answers[0].value], answersSum, type: r.type, creationTime: formatedDate })
        })
    ...
    if (phone) {
        return (
            <Box sx={{ width: "100%", minHeight: "100vh", height: "100%", }}>
                <Box sx={{ display: "flex", flexDirection: "column", height: "100%", width: "100%", alignItems: "center", gap: "10px", my: "10px", }}>
                    <Box sx={{ display: "flex", flexDirection: "column", boxShadow: " 0 3px 10px rgb(0 0 0 / 1)", width: "94%", height: "100%", justifyContent: "space-around", alignContent: "space-around", alignItems: "stretch" }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", width: "94%", justifyContent: "center", alignItems: "center", boxShadow: " 0 3px 10px rgb(0 0 0 / 1)", }}>
                    ...
                    <Box sx={{ width: "94%", display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", alignItems: "center", boxShadow: " 0 3px 10px rgb(0 0 0 / 1)" }}>
                        <p sx={{ textDecoration: "underline" }} >
                            Ergebnis:
                        </p>
                        <Box >
